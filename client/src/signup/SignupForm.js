...
export default function SignupForm(props) {
  ...
  const [isEditMailAddress, setIsEditMailAddress] = useState(false); //by aa
  const [homeAddress, setHomeAddress] = useState(""); //by aa
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} container>
              <TextField
                ...
                helperText={
                  !props.passwordsMatch ? "Passwords do not match." : ""
                }
              />
            </Grid>
            <Grid item xs={12} container>
              <TextField
                ...
                helperText={
                  props.emailExists
                    ? "This email was already used to sign up."
                    : ""
                }
              />
            </Grid>
            <Grid item xs={12} container>
              <TextField
                ...
                helperText={
                  props.phoneExists
                    ? "This phone number was already used to sign up."
                    : ""
                }
              />
            </Grid>
            ...
            <Grid item xs={12} container>
              <Tooltip
                ...
                title="The minimum amount of people you're interested to live with"
              >
                <TextField
                  variant="outlined"
                  required
            ...
            <Grid item xs={12} container>
              <Tooltip
                disableFocusListener
                title="The maximum amount of people you're interested to live with"
              >
                <TextField
                  variant="outlined"
                  required
            ...
            >
              <FormLabel component="legend">
                Do you have health or mobility issues?
              </FormLabel>
              <FormControl component="fieldset">
                <RadioGroup
            ...
            >
              <FormLabel component="legend">
                Do you prefer others with the same religion?
              </FormLabel>
              <FormControl component="fieldset">
                <RadioGroup
                  aria-label="religion"
            ...
            >
              <FormLabel component="legend">
                Are you a smoker or are smoking friendly?
              </FormLabel>
              <FormControl component="fieldset">
                <RadioGroup
                  aria-label="smoke"
            ...
            >
              ...
              <FormControl component="fieldset">
                ...
                <RadioText
                  check={props.formData.allergies}
                  name="allergiesText"
