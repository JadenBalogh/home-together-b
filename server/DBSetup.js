...
insert('CategoryType(parentId, name, paymentRequired)', [
  ...
  [24, 'Understanding Home Sharing & Taxes', false],
  [24, 'Multi-Tenant Rentals & Leases', false],
  [24, 'Shared Homes A-Z', false],
...
insert('Listing(approvalStatus, title, creationDate, website, phone, email, description, ratingAverage, locationId, categoryId, organizationId)', [
  ...
  [true,'Dagwood Senior\'s Community', new Date('2020-11-12'), 'No Website', '250-555-2301', 'DagwoodCommunity@gmail.test', 'Come join us for a free seminar about our community living initative, tea and snacks will be provided! Dagwood Senior Center is home to the Dagwood ride-sharing and community assistance club, contact us for details!', 3, 1, 534, 54],
  [true,'YMCA Healthy Living Initiative', new Date('2020-11-21'), 'ymca.ca', '250-555-3001', 'HealthyLiving@ymca.ca', 'Come join us for our new living alone seminar, where we\'ll cover budgeting, cooking at home, common household maintenance and repairs, and much more!', 3, 1, 534, 84],
  [true,'BC Housing - Housing Placement Service', new Date('2020-11-26'), 'placement.housingassistance.gov.bc.ca', '250-555-8000', 'HousingAssistance@gov.bc.ca', 'We\'ll help you find an afforable place to live', 4, 1, 604, 44],
  [true,'BC Housing - Lease Assistance Service', new Date('2015-12-06'), 'leasehelp.housingassistance.gov.bc.ca', '250-555-8001', 'HousingAssistance@gov.bc.ca', 'We\'ll help you create, mange disputes, and understand lease agreements in BC', 4, 1, 644, 44],
  [true,'Jeff', new Date('2021-03-15'), 'No Website', '250-555-8001', 'No E-Mail', '70+ Year old Male, looking for assistance around the house in exchange for a free room. Utilities extra.', 4, 1, 664, 64],
]);
